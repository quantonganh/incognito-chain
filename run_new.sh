...
if [ "$1" == "s22" ]; then
go run *.go --discoverpeersaddress "0.0.0.0:9330" --miningkeys "bls:12ThTo7fVqpqHwgyhTERqRNd8YqPHsVgNawbNBQGJMRqLpAD6yW" --nodemode "auto" --datadir "data/s22" --listen "0.0.0.0:8355" --externaladdress "0.0.0.0:8355" --norpcauth --rpclisten "0.0.0.0:9355" --norpc
fi
if [ "$1" == "s23" ]; then
go run *.go --discoverpeersaddress "0.0.0.0:9330" --miningkeys "bls:12GgJqDQzATnG2CMCTAu6Bnkq8zX6bimuqdy3kN7K8rRTcgU3X6" --nodemode "auto" --datadir "data/s23" --listen "0.0.0.0:8356" --externaladdress "0.0.0.0:8356" --norpcauth --rpclisten "0.0.0.0:9356" --norpc
fi
if [ "$1" == "s24" ]; then
go run *.go --discoverpeersaddress "0.0.0.0:9330" --miningkeys "bls:12wP2tDBK8dYq8UcKzwxZtS19JhyjUQZS1eE5uFbtckeSQbZBfg" --nodemode "auto" --datadir "data/s24" --listen "0.0.0.0:8357" --externaladdress "0.0.0.0:8357" --norpcauth --rpclisten "0.0.0.0:9357" --norpc
fi
if [ "$1" == "st1" ]; then
